...
// supported ciphers use different, non-interchangeable key sizes (BTP_V1.md
// section 8.5: 16 octets for AES-128-GCM, 32 for ChaCha20-Poly1305), so a
...
// Seals one logical message with AES-128-GCM (BTP_V1.md section 8.1).
...
// already includes the trailing 16-octet tag (BTP_V1.md section 8.4);
...
// Seals one logical message with ChaCha20-Poly1305 (BTP_V1.md section 8.1).
// out_ciphertext_and_tag must have room for payload_size + 16 octets.
...
// ciphertext_size already includes the trailing 16-octet tag (BTP_V1.md
// section 8.4); out_plaintext must have room for ciphertext_size - 16 octets.
...
// the CIPHER_ID sub-field of header.flags (BTP_V1.md section 8.1).
...
// the trailing 16-octet tag (BTP_V1.md section 8.4).
